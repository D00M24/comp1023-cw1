...
public class GameOverScreen implements Screen {
    ...
    private static final float FIXED_WIDTH = 1400;
    private static final float FIXED_HEIGHT = 900;
    ...
    public GameOverScreen(MainGame game) {
        ...
        // Load textures
        gameOverImage = new Texture("ui/game_over_screen.jpg");
        againButtonTexture = new Texture("ui/Again_button.png");
        mainButtonTexture = new Texture("ui/Main_button.png");
